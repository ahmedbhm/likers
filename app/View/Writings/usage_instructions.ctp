...
<div class="col-md-10 col-xs-12">
		...
		<!--titre-->
			<div class="col-md-12">
				<h2> تعليمات الإستخدام  </h2>
				
			</div>
			<div class="col-md-12">
				<ol class="breadcrumb">
				  <li><a href="#">الرئسية</a></li>
				  <li class="active"> تعليمات الإستخدام </li>
				</ol>
		</div>
		<!--fin titre-->
			<!--member-->
...
<div class="div-margin">
        <h3>تعليمات الإستخدام</h3>
        <hr />
        <div id="summernote"><?php echo $UsageInstructions[0]['Writing']['contents'];?></div>
        <?php echo $this->Form->create('Writing',array('action'=>'usage_instructions')); ?>
