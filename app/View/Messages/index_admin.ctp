...
<div class="col-md-8">
    <div class="row">
     <div class="col-md-2 col-sm-2 hidden-xs">
         <p style="padding:20px 10px; background: #557CC1; color: #FFF; text-align: center;">المستخدم</p>
    </div>
...
<div class="col-md-8">
    <div class="row">
 <div class="col-md-2 col-sm-2 hidden-xs">
         <p style="padding:20px 10px; background: #DE4E4E; color: #FFF; text-align: center;">الإدارة</p>
    </div>
    <div class="col-md-10 col-sm-10">
...
<?php } 
          ...
          <hr/>
          <br>
<?= $this->Form->create('Message',array('action'=>'add_admin','class'=>'form-horizontal')) ?>
 <div class="form-group">
 <div class="col-md-8 ">
      <input type="hidden"  class="form-control" id="TicketId"name="data[Ticket][id]" >
         
     <textarea class="form-control" name="data[Message][content]"></textarea>
     <input type="hidden" name="data[Message][ticket_id]" value="<?= $AllMessages[0]['Ticket']['id']?>">
 </div>
  </div>
 <div class="form-group">
      <div class="col-md-2">
          <select class="form-control" name="data[Message][statu_id]">
